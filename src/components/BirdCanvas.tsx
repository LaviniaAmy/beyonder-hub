...
const SKY_COLORS = ["#1c1428", "#3a2850", "#7a4060", "#c87060", "#f0c090"];
const SKY_STOPS  = [0, 0.18, 0.38, 0.58, 0.80];
...
const NUM_BIRDS = 220, NUM_GROUPS = 5;
...
const BirdCanvas = () => {
  ...
  useEffect(() => {
    ...
    function drawSky() {
      ...
      const hy = H * 0.70;
      const sg = ctx.createRadialGradient(W * 0.5, hy, 0, W * 0.5, hy, W * 0.45);
      sg.addColorStop(0,    "rgba(210,150,110,0.18)");
      sg.addColorStop(0.35, "rgba(190,100,90,0.07)");
      sg.addColorStop(1,    "rgba(160,70,60,0)");
      ctx.fillStyle = sg;
      ctx.fillRect(0, 0, W, H);
    }
