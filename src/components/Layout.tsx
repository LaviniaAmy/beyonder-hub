  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <header
        className={[
          "z-50 w-full",
          // fixed header always (so it can transition + hide/reveal)
          "fixed top-0 left-0 right-0",
          "transition-[transform,background-color,box-shadow] duration-300 ease-out will-change-transform",
          // hide/reveal (desktop only—logic already gates this, but safe)
          isHidden ? "md:-translate-y-full" : "translate-y-0",
          // non-home pages remain solid navy
          !isHomepage ? "bg-navy-800 shadow-md text-white" : "",
          // homepage states: transparent over hero, glass after scroll
          isHomepage && !isPastHero ? "bg-transparent" : "",
          isHomepage && isPastHero ? "bg-white/70 backdrop-blur-xl border-b border-black/5 shadow-sm" : "",
        ].join(" ")}
      >
