...
const pillarOut = (e: React.MouseEvent<HTMLAnchorElement>, hi: boolean) => {
  e.currentTarget.style.background = hi ? "rgba(255,255,255,0.06)" : "transparent";
};
  ...
  return (
    <div style={{ fontFamily: "'Nunito Sans', sans-serif" }}>
      ...
      <div className="md:hidden" style={{ background: C.cream, minHeight: "100vh", paddingBottom: 72 }}>
        ...
        {/* ── Mobile Hero ── */}
        <div style={{ background: "linear-gradient(180deg, #0e152a 0%, #13244e 28%, #20447f 55%, #2f6ca2 75%, #72b3cf 100%)", padding: "14px 20px 0", position: "relative", overflow: "hidden" }}>
          {/* Gradient glows */}
      ...
      <div className="hidden md:block" style={{ background: C.cream }}>
        ...
        <section style={{ position: "relative", overflow: "hidden",
          ...
          <div style={{ position: "absolute", top: "clamp(48px, 9vh, 80px)", left: 0, right: 0, zIndex: 3,
            ...
            <div style={{ marginTop: 10, width: "min(480px, 80vw)", height: 1,
              background: "linear-gradient(to right, transparent, rgba(120,200,255,0.22), transparent)" }} />
          </div>

          {/* Tagline — pinned independently */}
          <p style={{ position: "absolute", top: "clamp(185px, 32vh, 248px)", left: 0, right: 0, zIndex: 3,
            fontSize: "1rem", color: "rgba(232,244,255,0.50)", fontWeight: 300, margin: 0, textAlign: "center" }}>
            One place for everything SEND
          </p>

          {/* Search bar + chips — pinned independently */}
          <div style={{ position: "absolute", top: "clamp(222px, 39vh, 292px)", left: 0, right: 0, zIndex: 3,
            display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <section style={{ background: "linear-gradient(180deg, #13244e 0%, #20447f 100%)",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", maxWidth: 1280, margin: "0 auto" }}>
            {([
              ...
              <Link key={p.label} to={p.to} style={{ padding: "20px 28px",
                ...
                background: p.hi ? "rgba(255,255,255,0.06)" : "transparent",
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 12, color: "rgba(255,255,255,0.65)", fontWeight: 300, marginTop: 2 }}>
                    {p.sub}
                  </div>
                </div>
