        ...
        >
          ...
          <div className="absolute top-0 right-0 h-full z-10 w-[55%] min-w-[712px] lg:w-[48%] pointer-events-none">
            ...
            <div className="absolute inset-0 z-40 -translate-y-[15px] translate-x-[60px] flex flex-col items-center justify-center pt-[60px]">
              <img src={LogoPrimary} className="w-[580px] mb-1" alt="Beyonder" />
              ...
              <div
                ...
                style={{ fontSize: "36px", fontFamily: "'Jost', sans-serif", letterSpacing: "0.02em" }}
              >
          ...
          <div className="absolute z-20 flex flex-col gap-6" style={{ left: "780px", top: "620px" }}>
            <Button
              className="text-[#0A1A2F] px-14 py-8 rounded-full text-xl font-semibold shadow-lg w-[450px] border-0"
              style={{ background: "linear-gradient(180deg, #EFCF67 0%, #FF8563 100%)" }}
              onClick={() => navigate("/explore")}
            >
              Explore Services
            </Button>
            <Button
              className="bg-[#0A1A2F] text-white px-14 py-8 rounded-full text-xl font-semibold shadow-lg hover:bg-[#0C223D] w-[450px] border-0"
