    ...
    <div className="w-full bg-[#F8F7F3]">
      ...
      <section className="relative w-full h-[650px] overflow-hidden flex items-center">
        ...
        <div className="absolute top-0 right-0 w-[48%] h-full pointer-events-none z-10">
          ...
          <img
            src={TealLight}
            className="absolute top-0 right-0 h-full w-[130%] object-contain z-10 scale-[1.5] -translate-x-[38%] translate-y-[6%]"
            alt=""
          />

          <img
            src={TealDark}
            className="absolute top-0 right-0 h-full w-[130%] object-contain z-20 scale-[1.5] -translate-x-[38%] translate-y-[6%]"
            alt=""
          />

          {/* Curved Video Mask */}
          <div className="absolute inset-0 z-30 overflow-hidden" style={{ clipPath: "ellipse(90% 100% at 100% 50%)" }}>
