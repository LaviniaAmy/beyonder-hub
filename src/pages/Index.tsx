    ...
    <div className="w-full bg-[#F8F7F3]">
      ...
      <section className="relative w-full h-[650px] overflow-hidden flex items-center">
        ...
        <div className="absolute top-0 right-0 h-full z-10 w-[55%] min-w-[712px] lg:w-[48%] pointer-events-none">
          ...
          {/* Logo Overlay */}
          <div className="absolute inset-0 z-40 -translate-y-[60px] translate-x-[60px] flex flex-col items-center justify-center">
        ...
        <div className="container mx-auto px-10 relative z-20 flex flex-col gap-10 py-20">
          {/* Side Icons */}
          <div className="flex flex-col gap-10 ml-6 w-[130px]">
            {sideIcons.map((item) => (
          ...
          <div className="absolute top-[410px] left-1/2 -translate-x-1/2 z-30 flex flex-col gap-6 lg:ml-[250px] lg:-mt-[60px] lg:translate-x-[70px]">
            <Button
