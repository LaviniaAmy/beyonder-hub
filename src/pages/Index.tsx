    ...
    <div className="w-full bg-[#F8F7F3]">
      ...
      <section className="relative w-full h-[650px] overflow-hidden flex items-center">
        ...
        <div className="container mx-auto px-10 relative z-20 flex flex-col gap-10 py-20">
          {/* Side Icons */}
          <div className="flex flex-col gap-10 ml-10 w-[130px]">
            {sideIcons.map((item) => (
          ...
          <div className="flex flex-col gap-6 mt-2 lg:ml-[250px] lg:-mt-[60px] md:translate-x-[80px] lg:translate-x-[250px] xl:translate-x-[210px]">
            <Button
